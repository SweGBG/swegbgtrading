...
export default function AdminPage() {
  ...
  const openScraper = () => { setScraperOpen(true); setPriceOpen(false); };
  const openPrice = () => { setPriceOpen(true); setScraperOpen(false); };
  ...
  const tabs: { id: Tab; label: string }[] = [
    ...
    { id: "products", label: `Produkter (${products.length})` },
    { id: "messages", label: `Meddelanden${unreadMessages > 0 ? ` (${unreadMessages})` : ""}` },
    { id: "tools", label: "Web Crawler" },
    { id: "pricetracking", label: "Pris Bevakning" },
  ];
    ...
    <main style={{ minHeight: "100vh", background: "#0a0a0a", overflow: "hidden" }}>
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse at 70% 20%, rgba(180,140,60,0.06) 0%, transparent 50%), radial-gradient(ellipse at 20% 80%, rgba(40,80,160,0.05) 0%, transparent 50%)",
        }}
      />
      <div
        style={{
        ...
        >
          ...
          <div
            style={{
              marginTop: "20px",
              height: "1px",
              background: "linear-gradient(90deg, rgba(180,140,60,0.4), transparent)",
            }}
          />
        </motion.div>
            ...
            {tabs.map((tab, i) => (
              <motion.button
                ...
                style={{
                  ...
                  padding: "12px 16px",
                  background:
                    activeTab === tab.id ? "rgba(180,140,60,0.12)" : "transparent",
                  color:
                    activeTab === tab.id
                      ? "rgba(180,140,60,0.9)"
          ...
          >
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {editingProduct ? (
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                      {products.length === 0 && (
                        <p style={{ color: "rgba(255,255,255,0.25)", fontSize: "13px", letterSpacing: "2px" }}>
                        ...
                        >
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
                            <button
                              ...
                              style={{ padding: "7px 14px", background: "rgba(180,140,60,0.1)", border: "1px solid rgba(180,140,60,0.3)", borderRadius: "6px", color: "rgba(180,140,60,0.8)", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer", whiteSpace: "nowrap" }}
                            >
                              Redigera
                            </button>
                            <button
                              onClick={() => deleteProduct(product.id)}
                              style={{ padding: "7px 14px", background: "rgba(255,80,80,0.08)", border: "1px solid rgba(255,80,80,0.2)", borderRadius: "6px", color: "rgba(255,80,80,0.6)", fontSize: "11px", letterSpacing: "2px", textTransform: "uppercase", cursor: "pointer", whiteSpace: "nowrap" }}
                            >
                              Ta bort
                            </button>
                          </div>
              ...
              {activeTab === "pricetracking" && (
                ...
                >
                  <p style={{ fontSize: "10px", letterSpacing: "4px", color: "rgba(180,140,60,0.5)", textTransform: "uppercase", marginBottom: "16px" }}>Research & Intelligence</p>
                  <h2 style={{ fontSize: "clamp(20px, 4vw, 24px)", fontWeight: "700", color: "rgba(255,255,255,0.85)", marginBottom: "12px" }}>Pris Bevakning</h2>
                  <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.4)", marginBottom: "28px", letterSpacing: "0.5px" }}>
                    Klicka på 📊 ikonen nere till höger för att öppna verktyget.
                  </p>
                </motion.div>
