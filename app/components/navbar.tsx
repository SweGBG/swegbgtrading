  ...
  return (
    <>
      ...
      <nav style={{
        ...
        zIndex: 50, backgroundColor: 'rgba(255,255,255,0.8)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <Link href="/" style={{ textDecoration: 'none', color: '#000', fontSize: '1.5rem', fontWeight: 'bold', letterSpacing: '2px' }}>
            SWEGBG
          </Link>
        </div>
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <Link href="/kaffe" style={{ textDecoration: 'none', color: '#000' }}></Link>
          ...
          {user ? (
            <>
              <Link href="/konto" style={{ textDecoration: 'none', color: '#000' }}>Mitt konto</Link>
              <button
                onClick={handleLogout}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#000', fontSize: '16px' }}
              >
                Logga ut
              </button>
            </>
          ...
          <Link href="/varukorg" style={{ textDecoration: 'none', color: '#000', position: 'relative', marginLeft: '10px' }}>
            🛒
            {itemCount > 0 && (
              <span style={{
