  ...
  return (
    <>
        ...
        {isMenuOpen && (
          <>
            ...
            >
              ...
              <button
                onClick={() => setIsMenuOpen(false)}
                style={{ position: "relative", background: "none", border: "none", cursor: "pointer", marginBottom: "48px", display: "flex", alignItems: "center", gap: "10px", color: "rgba(255,255,255,0.3)", fontSize: "11px", letterSpacing: "4px", textTransform: "uppercase" }}
              >
                ✕ Stäng
              </button>
                ...
                {menuLinks.map((link, i) => (
                  <motion.li key={link.href} initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.07 }}>
                    <Link href={link.href} onClick={() => setIsMenuOpen(false)} style={{ textDecoration: "none" }}>
                      <div
                        style={{ padding: "14px 0", borderBottom: "1px solid rgba(255,255,255,0.04)", display: "flex", justifyContent: "space-between", alignItems: "center", color: "rgba(255,255,255,0.65)", fontSize: "15px", letterSpacing: "2px", transition: "color 0.2s" }}
                  ...
                  {user ? (
                    <>
                      <Link href="/konto" onClick={() => setIsMenuOpen(false)} style={{ textDecoration: "none" }}>
                        <div
                          style={{ padding: "14px 0", borderBottom: "1px solid rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.65)", fontSize: "15px", letterSpacing: "2px" }}
                          onMouseEnter={e => (e.currentTarget.style.color = "rgba(180,140,60,0.9)")}
                          onMouseLeave={e => (e.currentTarget.style.color = "rgba(255,255,255,0.65)")}
                        >
                          Mitt konto
                      ...
                      {user.email === ADMIN_EMAIL && (
                        <Link href="/admin" onClick={() => setIsMenuOpen(false)} style={{ textDecoration: "none" }}>
                          <div
                            style={{ padding: "14px 0", borderBottom: "1px solid rgba(255,255,255,0.04)", color: "rgba(180,140,60,0.7)", fontSize: "15px", letterSpacing: "2px" }}
                            onMouseEnter={e => (e.currentTarget.style.color = "rgba(180,140,60,1)")}
                            onMouseLeave={e => (e.currentTarget.style.color = "rgba(180,140,60,0.7)")}
                          >
                            ⚙️ Admin
                          </div>
                        </Link>
                      ...
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,80,80,0.5)", fontSize: "14px", padding: "14px 0", width: "100%", textAlign: "left", letterSpacing: "2px" }}
                      >
                        Logga ut
                      </button>
                    </>
                    ...
                    <Link href="/medlem" onClick={() => setIsMenuOpen(false)} style={{ textDecoration: "none" }}>
                      <div style={{ padding: "14px 0", color: "rgba(255,255,255,0.65)", fontSize: "15px", letterSpacing: "2px" }}>
                        Logga in
                      </div>
                    </Link>
                  )}
      ...
      <nav style={{
        ...
        backgroundColor: scrolled ? "rgba(132,99,34,0.4)" : "rgba(100,75,20,0.25)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "18px" }}>
          <div
            ...
            style={{ cursor: "pointer", userSelect: "none", display: "flex", flexDirection: "column", gap: "5px", padding: "4px" }}
          >
            {[0, 1, 2].map((i) => (
        ...
        {/* HÖGER — desktop-länkar + konto-dropdown + varukorg */}
        <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
          ...
          <div data-dropdown style={{ position: "relative" }}>
            <div
              ...
              style={{ width: "36px", height: "36px", border: "1px solid rgba(180,140,60,0.3)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.7)", fontSize: "16px", cursor: "pointer" }}
            >
              👤
            </div>
            <AnimatePresence>
                  ...
                  {user ? (
                    <>
                      <Link href="/konto" onClick={() => setDropdownOpen(false)} style={{ textDecoration: "none" }}>
                        <div
                          style={{ padding: "12px 16px", color: "rgba(255,255,255,0.65)", fontSize: "13px", letterSpacing: "1px", borderBottom: "1px solid rgba(255,255,255,0.05)", cursor: "pointer" }}
                      ...
                      {user.email === ADMIN_EMAIL && (
                        <Link href="/admin" onClick={() => setDropdownOpen(false)} style={{ textDecoration: "none" }}>
                          <div
                            style={{ padding: "12px 16px", color: "rgba(180,140,60,0.7)", fontSize: "13px", letterSpacing: "1px", borderBottom: "1px solid rgba(255,255,255,0.05)", cursor: "pointer" }}
                            onMouseEnter={e => (e.currentTarget.style.background = "rgba(180,140,60,0.08)")}
                            onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
                          >
                            ⚙️ Admin
                      ...
                      <div
                        ...
                        style={{ padding: "12px 16px", color: "rgba(255,80,80,0.6)", fontSize: "13px", letterSpacing: "1px", cursor: "pointer" }}
                    ...
                    <Link href="/medlem" onClick={() => setDropdownOpen(false)} style={{ textDecoration: "none" }}>
                      <div
                        style={{ padding: "12px 16px", color: "rgba(180,140,60,0.8)", fontSize: "13px", letterSpacing: "1px", cursor: "pointer" }}
                        onMouseEnter={e => (e.currentTarget.style.background = "rgba(180,140,60,0.08)")}
                        onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
                      >
                        Logga in
          ...
          <Link href="/varukorg" style={{ textDecoration: "none", position: "relative" }}>
            ...
            {itemCount > 0 && (
              <motion.span
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                style={{ position: "absolute", top: "-4px", right: "-4px", background: "linear-gradient(135deg, #b48c3c, #e8c06a)", color: "#000", borderRadius: "50%", width: "18px", height: "18px", fontSize: "10px", fontWeight: "700", display: "flex", alignItems: "center", justifyContent: "center" }}
              >
                {itemCount}
              </motion.span>
            )}
