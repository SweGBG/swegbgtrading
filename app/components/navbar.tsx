        ...
        {isMenuOpen && (
          <>
            ...
            >
              ...
              <div style={{
                height: "1px",
                background: "linear-gradient(90deg, rgba(180,140,60,0.3), transparent)",
                marginBottom: "16px",
              }} />
                    ...
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          color: "rgba(255,80,80,0.5)", fontSize: "14px",
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "18px" }}>
          ...
          <Link href="/" style={{ textDecoration: "none" }}>
            <span style={{ fontSize: "14px", fontWeight: "700", letterSpacing: "4px", color: "rgba(255,255,255,0.9)" }}>
              SWEGBG
            </span>
          </Link>
        </div>
