  ...
  return (
    <main style={{ minHeight: "100vh", background: "#0a0a0a", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at 50% 30%, rgba(40,100,80,0.08) 0%, transparent 60%)",
      }} />
      <div style={{
        position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none",
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            background: "linear-gradient(90deg, transparent, rgba(60,160,100,0.6), transparent)",
            margin: "32px 0",
          }}
        />
        ...
        {/* PULSERANDE RINGAR — grön ton för te */}
